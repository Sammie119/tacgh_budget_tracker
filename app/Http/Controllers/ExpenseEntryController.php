...
class ExpenseEntryController extends Controller
{
    ...
    {
        $data['expense_entries'] = ExpenseEntry::all();
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('expense_entries', absolute: false))->with('success', 'Expense Entry Created Successfully!!!');
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect(route('expense_entries', absolute: false))->with('success', 'Expense Entry Updated Successfully!!!');
    }
    ...
    public function destroy(Request $request)
    {
        ...
        if($expense->status == 1){
            return redirect(route('expense_entries', absolute: false))->with('error', 'Expense Entry cannot be Deleted, Its in Active State!!!');
        }

        $expense->delete();
        return redirect(route('expense_entries', absolute: false))->with('success', 'Budget Entry Deleted Successfully!!!');
    }
}
